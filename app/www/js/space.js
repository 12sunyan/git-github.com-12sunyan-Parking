    ...
    $http(getpark).then(function(res){
        ...
        $http(getspace).then(function(res2){
            ...
            $http(getallspace).then(function(res3){
                ...
                context.lineTo(0.1*width,($scope.parkspace.xpos-0.95)*height);
                context.lineTo(($scope.parkspace.y-0.5)*width,($scope.parkspace.xpos-0.95)*height);
                context.lineTo(($scope.parkspace.y-0.5)*width,($scope.parkspace.xpos-0.65)*height);
                context.stroke();    
            });            
        });
    });
